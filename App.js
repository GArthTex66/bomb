...
export default class App extends Component {
  ...
  startCountdown = () => {
    ...
    let seconds = this.state.bombClock.seconds
      ? this.state.bombClock.seconds
      : 0;
    let minutes = this.state.bombClock.minutes
      ? this.state.bombClock.minutes
      : 0;
    ...
    if (diffTime > 0) {
      this.countdownInterval = setInterval(() => {
        ...
        if (
          ...
          this.setState({message: 'BOOOOOOM'});
  ...
  bombActivation = () => {
    ...
    if (this.state.start) {
      ...
      this.setState({
        start: true,
        status: 'Stop',
        passwordSaved: this.state.password,
        password: '',
